	...
	<table width="100%" height="100%" border="0" cellpadding="0"
		...
		<tr>
			...
			<td width="173" id="frmTitle" noWrap align="center" valign="top" height="100%">
				<iframe src="left.jsp" name="leftFrame" id="frame_left" height="450" width="180" frameborder="0" scrolling="no">
					浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe>
			</td>
			<td width="8" valign="middle" background="images/main_12.gif"></td>
			<td align="center" valign="top">
				<iframe src="right.jsp" name="rightFrame" id="frame_right" height="450" width="100%" frameborder="0">
					浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe>
			</td>
