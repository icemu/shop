			...
			<td>
				<div class="meun_div" align="center">
					...
					<div class="meun_box none_box" id="box3">
						<ul>
							<li><a href="productList.action"  target="rightFrame">&middot;商品列表</a></li>
							<li><a href="productA.action"  target="rightFrame">&middot;添加商品</a></li>
					...
					<div class="meun_top">
						...
						<a onclick="show_menu_box(6)" href="javascript:;">管理员管理</a>
					</div>
					<div class="meun_box none_box" id="box6">
						<ul>
							<li><a href="adminList.action"  target="rightFrame">&middot;管理员列表</a></li>
